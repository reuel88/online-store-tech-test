...
2. Category page that displays products fetched from the [Fake Store API](https://fakestoreapi.com/) with each product card displaying an add to cart button
3. Dismissable cart pop over which lists products, shows the order total, allows removal of products and displays a console.log or alert on checkout
